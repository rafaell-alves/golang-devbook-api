...
// CriarUsuario insere um usuario
...
// BuscarUsarios busca todos os usuarios
...
// AtualizarUsarios atualiza  um usuario
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusBadRequest, errors.New("Não é possivel atualizar o usuario porque não é o seu"))
		return
	}
...
// DeletarUsuario excluir  um usuario
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel atualizar usuario diferente do seu"))
		return
	}
	...
	if erro = seguranca.VerificarSenha(senha.Atual, senhaSalvaNoBanco); erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, errors.New("A senha atual não condiz com a do banco"))
		return
	}
